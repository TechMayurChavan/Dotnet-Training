...
namespace If_statement
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int obj1 = Sub(a, b);
            Console.WriteLine("The Substraction of numbers is :" + obj1);
            int obj2 = Mul(a, b);
            Console.WriteLine("The Multiplication of numbers is :" + obj2);
            int obj3 = Div(a, b);
            Console.WriteLine("The Division  of numbers is :" + obj3);
            int obj4 = Square(a);
            Console.WriteLine("The Square  of numbers is :" + obj4);
